      ...
      milestones:
        ...
        - id: M4.3
          ...
          verification: "A Test phase run over mpgm itself, which is what M3.2 named and
            ...
            recorded as one a reviewer refused."
          validatesRisk: null
          tasks:
            - id: T4.3.1

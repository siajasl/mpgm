      ...
      milestones:
        ...
        - id: M4.3
          ...
          verification: "A Test phase run over mpgm itself, which is what M3.2 named and
            ...
            found rather than over an empty set."
          validatesRisk: null
          tasks:
            - id: T4.3.1

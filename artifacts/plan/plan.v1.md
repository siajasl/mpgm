            ...
            - id: T4.1.5
              ...
              completionCriteria:
                - An operator can roll back a declared environment from the CLI,
                  and the rollback is recorded, gated only when the digest was

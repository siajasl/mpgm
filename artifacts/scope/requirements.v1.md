...
data:
  ...
  requirements:
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — Orchestration (ORC).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — Agents (AGT).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — Safety & Policy (SAF).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — Extensibility (EXT).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.1 Definition (DEF).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.2 Scope (SCP).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.3 Design (DSG).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.4 Plan (PLN).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.5 Implement (IMP).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.6 Test (TST).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 5.7 Deploy (DEP).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      statement: "The harness MUST ingest the operational signal sources declared in
        ...
        items."
      rationale: Carried from REQUIREMENTS.md — 5.8 Maintain (MNT).
      priority: must
      acceptanceCriteria:
    ...
    - kind: functional
      ...
      rationale: Carried from REQUIREMENTS.md — 6. Non-Functional Requirements (NFR).
        ...
        a later Scope revision to close, not this migration).
      priority: must
      acceptanceCriteria:

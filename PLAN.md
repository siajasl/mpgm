...
**Status:** v0.18 — T4.2.11 added: a prose line beginning with a trailer key is read as a trace claim, and the key that got through is `Verifies`, the only one coverage counts · **Owner:** macg@enthropic.io · **Last updated:** 2026-09-15

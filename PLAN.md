...
**Status:** v0.15 — T4.2.7 added: nothing on the task path names the artifacts it produced, and T4.2.2b's claim that `artifactRefs` is the only dating a filed defect has is corrected against `producedBy.task` · **Owner:** macg@enthropic.io · **Last updated:** 2026-09-15

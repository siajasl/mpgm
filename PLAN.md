...
**Status:** v0.17 — M4.2's verification had two legs no task delivered: T4.2.8 records a session's duration and T4.2.9 measures harness overhead against NFR-3, T4.2.10 times a clean install to a gated Definition artifact for NFR-6, and the generator's M4.2 verification regains the redirection leg PLAN.md carried alone · **Owner:** macg@enthropic.io · **Last updated:** 2026-09-15

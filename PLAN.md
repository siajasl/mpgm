...
**Status:** v0.14 — M4.2's observability tasks stated against what the log, the artifact store and the dashboard can actually answer: the quality-metrics task split into T4.2.2a and T4.2.2b, T4.2.1's row corrected to the CLI it was asked for, and the panels it also claimed filed as T4.2.6 · **Owner:** macg@enthropic.io · **Last updated:** 2026-09-14

...
export function renderLateDeviation(unseen: readonly string[]): string {
  return [
    ...
    'small.',
    '',
    'Declaring means the `deviations` field of the result you return, naming the',
    'convention in `convention` and your reason in `why`. A commit message is',
    'not a declaration, and this round is the last one there is.',
    '',
